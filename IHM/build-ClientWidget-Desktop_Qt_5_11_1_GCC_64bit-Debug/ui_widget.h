...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        widget = new QWidget(groupBoxConnexionAuServeur);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(20, 40, 571, 111));
        ...
        lineEditAdresseIP = new QLineEdit(widget);
        ...
        lineEditNumeroPort = new QLineEdit(widget);
        ...
        widget1 = new QWidget(groupBoxInformationClient);
        widget1->setObjectName(QStringLiteral("widget1"));
        widget1->setGeometry(QRect(10, 30, 571, 122));
        ...
        pushButtonNomOrdinateur = new QPushButton(widget1);
        ...
        lineEditNomOrdinateur = new QLineEdit(widget1);
        ...
        lineEditNomArchitecture = new QLineEdit(widget1);
